...
Demonstrates training and evaluation of NoMaD with reinforcement learning in AI2Thor
"""
...
import sys
sys.path.append(r'G:/My Drive/NCKH/Autonomous_Nav_Slam/visualnav-transformer')
...
from nomad_rl.training.nomad_rl_trainer import NoMaDRLTrainer
from nomad_rl.evaluation.nomad_rl_eval import NoMaDRLEvaluator
...
def demo_model():
    ...
    dummy_obs = {
        ...
        'context': torch.randn(1, 15, 96, 96).to(device),
...
def quick_training_demo():    
    config = create_sample_config()
    config['total_timesteps'] = 50000  # Increased from 5000
    config['log_freq'] = 2
    config['save_freq'] = 10
